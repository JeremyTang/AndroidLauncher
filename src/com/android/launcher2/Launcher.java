...
public final class Launcher extends Activity
	...
	//2014-9-26 added by Jacob to fix bug#7067:register locale changed to update the widget language
	private final BroadcastReceiver mLocaleChangedReceiver = new BroadcastReceiver () {
        @Override
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Intent.ACTION_LOCALE_CHANGED)) {
				Launcher.this.finish();//restart the Launcher to reloader widget
            }
        }
    };
